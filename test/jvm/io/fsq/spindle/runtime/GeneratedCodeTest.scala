...
import io.fsq.thriftexample.{Content, MutableTvListingEntry, TvListingEntry}
import io.fsq.thriftexample.TvlistingTypedefs.{MyLong, MyObjectId, MyString}
import io.fsq.thriftexample.av.Movie
import io.fsq.thriftexample.av.MovieTypedefs.{MinutesId, MovieId}
import io.fsq.thriftexample.people.{ContactInfo, Gender, Person, PhoneNumber, PhoneType}
import io.fsq.thriftexample.talent.{Actor, CrewMember}
...
class GeneratedCodeTest {
  ...
  @Test
  def testIdImplicits {
    import io.fsq.thriftexample.TvlistingTypedefImplicits._
